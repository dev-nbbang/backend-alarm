...
public class FailSearchNotifiesException extends NbbangCommonException {
    private final NbbangException nbbangException;
    private final String message;
    public FailSearchNotifiesException(String message, NbbangException nbbangException) {
        super(message);
