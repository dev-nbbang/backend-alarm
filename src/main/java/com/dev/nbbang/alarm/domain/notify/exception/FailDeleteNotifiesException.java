...
public class FailDeleteNotifiesException extends NbbangCommonException {
    private final NbbangException nbbangException;
    private final String message;
    public FailDeleteNotifiesException(String message, NbbangException nbbangException) {
        super(message);
